    ...
    return html`
      ...
      <wbi-center>
        ...
        <img src="./images/worbli.png" alt="Worbli">
          ...
          <label for="agree">
          <input type="checkbox" name="terms" id="terms" value="{{terms::input}}" on-change="_termsCheckbox">I agree to the <a href="/terms/" target="_blank">Terms and Privacy Policy</a></label>
          <label for="optIn">
