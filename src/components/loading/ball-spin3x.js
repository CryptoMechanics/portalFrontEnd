...
class BallSpin3x extends ReduxMixin(PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="la-ball-spin-clockwise-fade la-dark la-3x">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
...
} window.customElements.define('ball-spin3x', BallSpin3x);
