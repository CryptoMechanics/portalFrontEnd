export const translations = {
  English: {
    ...
    SelectTheDocumentBelow: 'Select the document you want to take a photo of below',
    allDone: 'All Done!',
    returnToTheDesktopToComplete: 'Return to the desktop to complete your application',
    selfie: 'Selfie',
